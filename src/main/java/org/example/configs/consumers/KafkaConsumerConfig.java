...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, UserRegisteredEvent> consumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "org.example.DTO.UserRegisteredEvent");

        return new DefaultKafkaConsumerFactory<>(
                props,
                new StringDeserializer(),
                new JsonDeserializer<>(UserRegisteredEvent.class, false) // false — не использовать type headers
        );
    }
